 ...
 * @copyright 2006-2012 EPCS Pty Ltd (ABN 77 084 670 600)
...
class EPCS_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processPackage($errorPos)
    {
        ...
        if ($package !== null) {
            ...
            if (empty($content) === true) {
            ...
            } else if (strpos($content, 'EPCS') === 0) {
                // Package name must not start with EPCS.
                ...
                $this->currentFile->addError($error, $errorPos, 'EPCSPackage', $data);
            }
        }
